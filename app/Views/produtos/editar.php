<div class="content-wrapper">
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Editar Dados de Produto</h1>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="<?= base_url('inicio') ?>">Home</a></li>
              <li class="breadcrumb-item active">Editar Dados de Produto</li>
            </ol>
          </div>
        </div>
      </div>
                        ...
                        <div class="card-body">
                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-lg-3">
                                    ...
                                    <input type="text" class="form-control" placeholder="Informe o valor da compra" name="valor_de_compra" value="<?= number_format($produto['valor_de_compra'], 2, ',', '.') ?>">
                                </div>

                                <div class="form-group col-lg-3">
                                    <label for="valor_de_venda">Valor de Venda</label>
                                    <input type="text" class="form-control" placeholder="Informe o valor da venda" name="valor_de_venda" value="<?= number_format($produto['valor_de_venda'], 2, ',', '.') ?>">
                                </div>

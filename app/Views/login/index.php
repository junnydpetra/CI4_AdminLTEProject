    ...
    <body class="hold-transition login-page">
        <div class="login-box">            
            <div class="card card-outline card-primary">
                ...
                <div class="card-body">
                <p class="login-box-msg"><?= (isset($alert) && $alert == 'login_error') ? "<button type='button' class='btn btn-danger' data-toggle='modal' data-target='#modal-danger'>Usuário ou senha incorretos!</button>" : "Informe usuário e senha" ?></p>
